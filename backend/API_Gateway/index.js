...
app.use('/api/restaurant_admin', createProxyMiddleware({
    target: process.env.RES_ADMIN_SERVICE_URL,
    changeOrigin: true
}));

app.use('/api/res_front', createProxyMiddleware({
    target: process.env.RES_SERVICE_URL,
    changeOrigin: true
}));
