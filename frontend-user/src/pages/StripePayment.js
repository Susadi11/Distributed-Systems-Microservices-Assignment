...
import Header from '../components/Utility/Navbar';  
...
return (
    <>
        ...
        >
            ...
            <div className="flex-1 p-10 shadow-lg bg-white  space-y-8">
                <h2 className="text-2xl font-semibold text-[#4a3f55] mb-6">Your payment details</h2>

                <div className="p-5 bg-[#e6ebf7] rounded-xl space-y-6 border border-[#d9d9d9]">
                    <div>
                        <label className="block text-xs text-[#4a3f55] mb-1 font-normal" htmlFor="cardNumber">
                            Card Number
                        </label>
                    ...
                    <div>
                        <label className="block text-xs text-[#4a3f55] mb-1 font-normal" htmlFor="cardExpiry">
                            Expiry Date
                        </label>
                        <div className="p-3 bg-white border border-[#d9d9d9] rounded-lg">
                            <CardExpiryElement />
                    ...
                    <div>
                        <label className="block text-xs text-[#4a3f55] mb-1 font-normal" htmlFor="cardCvc">
                            CVC
                        </label>
                        <div className="p-3 bg-white border border-[#d9d9d9] rounded-lg">
                            <CardCvcElement />
  ...
  <label className="select-none" htmlFor="remember">
    Remember my card info
                ...
                {message && (
                    <div className="text-center text-sm text-gray-800 mt-3">{message}</div>
                )}
            </div>
        </form>
    </>
