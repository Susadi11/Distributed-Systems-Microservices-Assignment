        ...
        <footer className="bg-white">
            <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                <div className="lg:flex lg:items-start lg:gap-8">
                    <div className="mt-8 grid grid-cols-3 gap-32 lg:mt-0 lg:grid-cols-5 lg:gap-y-24">
                        ...
                        <div className="col-span-2 sm:col-span-1">
                            <p className="font-medium text-gray-900">About Yum Yum</p>
                            <ul className="mt-6 space-y-4 text-sm">
                                <li>
                                    <a href="#" className="text-gray-700 transition hover:opacity-75">
                                        Our Story
                        ...
                        <div className="col-span-2 sm:col-span-1">
                            <p className="font-medium text-gray-900">Download Our App</p>
                            <ul className="mt-6 space-y-4 text-sm">
                                <li>
                                    <a href="#" className="text-gray-700 transition hover:opacity-75">
                                        iOS App
                ...
                <div class="mt-8 border-t border-gray-200 pt-8">
                    <div class="sm:flex sm:justify-between">
                        <p class="text-xs text-gray-500">&copy; 2025. YUM YUM. All rights reserved.</p>
